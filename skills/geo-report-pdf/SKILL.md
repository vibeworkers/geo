...
> 현재 대화에서 공유된 GEO 분석 결과나 전체 감사 출력 내용을 참조한다.
...
분석 완료 후 다시 이 PDF 보고서 workflow를 실행하세요.
```
...
| 시점 | 요청 예시 | 목적 |
|---|---|---|
| Sprint 1 완료 후 | `https://[도메인] 전체 감사` | 즉시 개선 효과 확인 |
| Sprint 2 완료 후 | `https://[도메인] 종합 보고서 생성` | 중간 성과 보고 |
| Sprint 3 완료 후 | `https://[도메인] 전체 감사` | 최종 점수 측정 |
