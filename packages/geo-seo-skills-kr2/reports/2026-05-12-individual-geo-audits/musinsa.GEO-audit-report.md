...
| llms.txt | 접근 실패: HTTPError: HTTP Error 404: Not Found |
...
| OG title | 무신사 |
| OG description | 패션의 모든 것, 다 무신사랑 해! 무신사에서 다양한 혜택과 스타일 팁을 확인해보세요. |
| Canonical | https://www.musinsa.com/main/musinsa/recommend |
| hreflang count | 14 |
| JSON-LD count | 0 |
| robots.txt 내 Sitemap | Sitemap: https://www.musinsa.com/sitemap-musinsa-index.xml |
| robots.txt 내 명시 AI bot user-agent | GPTBot, ChatGPT-User, ClaudeBot, Claude-User, PerplexityBot, Google-Extended, Applebot, CCBot |

## 4. GEO 관점 주요 리스크

1. llms.txt가 감지되지 않음
2. JSON-LD 구조화 데이터가 초기 HTML에서 감지되지 않음
