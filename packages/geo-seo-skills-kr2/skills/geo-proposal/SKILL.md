...
geo-audit의 심각도 4단계(CRITICAL/HIGH/MEDIUM/LOW)를 기반으로 Sprint에 배분한다.

| 단계 | 심각도 | 기준 | 예시 |
|---|---|---|---|
| Sprint 1 (1~2주) | CRITICAL + HIGH | 즉각 조치 필요 항목 우선 처리 | llms.txt 생성, robots.txt 수정, Organization 스키마 추가 |
| Sprint 2 (3~4주) | MEDIUM | 핵심 구조 개선 | FAQPage 스키마, speakable 설정, 콘텐츠 구조 개선 |
| Sprint 3 (1~3개월) | LOW | 외부 의존성·고난이도 항목 | 언론 보도 확보, llms-full.txt 자동화, Core Web Vitals 개선 |
...
| 시점 | 명령어 | 목적 |
|---|---|---|
| Sprint 1 완료 후 (2주차) | `/geo audit https://[도메인]` | CRITICAL·HIGH 개선 효과 확인 |
| Sprint 2 완료 후 (4주차) | `/geo report https://[도메인]` | 중간 성과 보고서 생성 |
| Sprint 3 완료 후 (3개월) | `/geo audit https://[도메인]` | 최종 GEO 점수 측정 |
```
