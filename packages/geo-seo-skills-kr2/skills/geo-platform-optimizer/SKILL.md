...
| 네이버 AI 탭 | SITE_LANGS에 ko | 에이전틱 대화형 검색 (Yeti 수집) | FAQPage 스키마 + AI 브리핑 연동 |
...
| Meta AI | 전체 | Facebook·Instagram 통합 AI | Meta-ExternalAgent 허용 + 소셜 채널 연계 |
...
네이버 AI 브리핑은 검색 결과 상단에 AI 요약을 표시하며, Yeti 봇이 콘텐츠를 수집한다.
AI 탭은 2026년 4월 베타 출시된 에이전틱 검색으로 AI 브리핑 최적화 기반에서 작동한다.
...
**지역 플랫폼 점수 (SITE_LANGS 조건부, 각 0–100점 별도 산출)**
